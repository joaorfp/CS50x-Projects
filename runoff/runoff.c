...
bool vote(int voter, int rank, string name)
{
    // iterates over candidates to see if name matches the name provided for ranking and if so records the preference
    for (int i = 0; i < candidate_count; i++)
    {
...
{
    // TODO
    int lowVote = candidates[0].votes;
    for (int i = 0; i < candidate_count; i++)
    {
